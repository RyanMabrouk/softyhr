...
export const Delete_Entry=async(champ:string, data:any,Entry_id:string)=>{
    ...
    const { data: user_profile, error } = await supabase
      ...
      console.log(error);
    console.log(error);
      if(error) return { error:{ Message: `Error Deleting ${champ}`, Type:error }}
}