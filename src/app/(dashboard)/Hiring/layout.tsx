...
export default function HiringLayout({ children }: LayoutHiringProps) {
  ...
  return (
    <div className="flex w-screen flex-col items-center justify-center bg-gray-14">
      <div className="mt-8 flex w-3/4 flex-col items-start justify-center gap-[0.5rem] text-black">
        ...
        <div className="flex w-full items-center justify-between ">
          <div className="flex items-center justify-center">
            {HirinSections?.map(({ label, path, Icon }: HirinSectionsType) => {
              ...
              return (
                ...
                >
                  <IconComponent
                    fontSize="1.7rem"
                    fill={ActiveRoute.includes(path) ? "#527A01" : "#686868"}
                  />
                  <h1
                    className={
