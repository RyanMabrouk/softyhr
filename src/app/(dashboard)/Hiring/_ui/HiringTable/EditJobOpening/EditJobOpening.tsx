...
import { MdEventNote, MdModeEditOutline, MdOutlineEventNote } from "react-icons/md";
...
function EditJobOpening({  text, id }: EditJobOpeningPropsType) {
  ...
  return (
    <DropDownGeneric
      DropDownButton={() => (
        <div className="flex h-[2rem] w-[2rem] cursor-pointer items-center justify-center duration-200 ease-in-out hover:border hover:border-gray-27 hover:bg-gray-22">
          <MdModeEditOutline
            className="text-lg"
            cursor={"pointer"}
            fill={"gray"}
