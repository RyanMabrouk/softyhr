  ...
  return (
    <div className=" relative flex h-screen w-screen flex-col overflow-x-hidden scroll-smooth">
      <nav className="sticky top-0 z-20 flex h-[5rem] w-full flex-row items-center justify-between bg-white px-8 py-4">
        ...
        <Link
          href="login"
          className="h-fit w-fit space-x-2 rounded-2xl border-2 border-solid border-color1-400 px-6 py-2 text-center text-[0.9rem] font-bold leading-[15px] tracking-[1px] text-color-green-4 transition-all duration-150 ease-linear  hover:border-color-green-4 hover:bg-color-green-4 hover:text-white"
        >
          Log In
        </Link>
      </nav>
