...
export function DomainInput() {
  return (
    <div className="focus-within:shadow-green group relative flex h-10 w-full flex-row items-center  justify-between border border-gray-300 bg-gray-14 transition-all duration-200 ease-in-out focus-within:shadow-[0px_0px_4px_1px_#84bf41] focus:border-transparent focus:outline-none focus:ring-2">
